...
import { FIREWORKS_KIMI_K3_MODEL_ID } from "@app/lib/model_constructors/types/model_ids";
import { z } from "zod";
...
export function WithFireworksKimiK3Config<
  TBase extends abstract new (
    ...args: any[]
  ) => object,
>(Base: TBase) {
  abstract class FireworksKimiK3 extends Base {
    static readonly modelId = FIREWORKS_KIMI_K3_MODEL_ID;

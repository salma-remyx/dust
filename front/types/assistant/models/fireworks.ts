...
export const FIREWORKS_KIMI_K3_MODEL_CONFIG: ModelConfigurationType = {
  ...
  largeModel: true,
  description:
    "Moonshot AI's Kimi K3 frontier Mixture-of-Experts model with a 1M-token context window and native vision (served via Fireworks).",
  shortDescription: "Kimi K3 with 1M context and vision.",
  isLegacy: false,
  isLatest: true,
  generationTokensCount: 64_000,
  supportsVision: true,

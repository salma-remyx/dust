...
const baseClasses = cn(
  ...
  // Track recolors in step with the knob slide; matched timing keeps them a unit.
  "transition-colors duration-200 ease-in-out motion-reduce:transition-none",
  // Subtle inner shadow to give the track depth (matches design spec).
    ...
    >
      <div
        ...
        className={cn(
          ...
          // On-screen movement → ease-in-out; matches the track's 200ms timing.

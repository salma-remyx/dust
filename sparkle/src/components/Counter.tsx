  ...
  "inline-flex items-center justify-center rounded-full",
  {
    ...
    compoundVariants: [
      ...
      },
      {
        ...
        className: cn(
          "bg-gradient-to-b from-highlight-light to-highlight text-white",
          pillShadow
        ),
      },
      {
        ...
        className: cn(
          "bg-gradient-to-b from-warning-light to-warning text-white",
          pillShadow
        ),
      },
      {
        ...
        variant: "info",
        className: cn(
          "bg-gradient-to-b from-info-light to-info text-white",
          pillShadow
        ),
      },
      {
